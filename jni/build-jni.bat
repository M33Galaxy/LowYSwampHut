...
gcc -std=c17 -O3 %CDEF% -c "%CUB%\generator.c" "%CUB%\layers.c" "%CUB%\biomenoise.c" "%CUB%\biomes.c" "%CUB%\noise.c" "%CUB%\util.c" "%CUB%\terrainnoise.c"
if errorlevel 1 exit /b 1
g++ -std=c++20 -O3 %CXXDEF% -c SwampHutPhase1.cpp
if errorlevel 1 exit /b 1
g++ -std=c++20 -O3 %CXXDEF% -c native/jni/project_CubiomesBridge.cpp -o bridge.o
if errorlevel 1 exit /b 1
g++ -shared -O3 -o "%OUT%\libLowYSwampHutJ.dll" generator.o layers.o biomenoise.o biomes.o noise.o util.o terrainnoise.o SwampHutPhase1.o bridge.o -static -static-libgcc -static-libstdc++ -lm
if errorlevel 1 exit /b 1
